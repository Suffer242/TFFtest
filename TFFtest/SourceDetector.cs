...
namespace MeGUI
{
    ...
    public delegate void FinishedAnalysis(DetectResult result, DeinterlaceFilter[] filters, bool error, string errorMessage);
    ...
    {
        public SourceType Type { set; get; }
        public FieldOrder FieldOrder { set; get; }
...
*/
        ...
        private void finishProcessing()
        {
            ...
            finishedAnalysis(
                new DetectResult { Text = analysis, FieldOrder = fieldOrder, Type = type}, filters.ToArray(), false, null);
